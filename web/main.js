...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      "%": "Client|DOMError|DOMImplementation|FileError|MediaError|NavigatorUserMediaError|PositionError|PushMessageData|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebGLRenderingContext|WindowClient"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 18, 0],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 4, 1, 2, 3],
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 14, 2, 3],
    ...
    AnchorElement: {
      "^": "HtmlElement;download},target=,href}",
      toString$0: function(receiver) {
        return String(receiver);
      },
      $isInterceptor: 1,
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 6, 6, 11, 0, 12],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          ...
          if (!t1)
            ...
            t1 = true;
          return t1;
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 6, 6, 11, 0, 12]
      }
    },
    ImmutableListMixin: {
      "^": "Object;$ti",
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 19, 13],
    ...
    loadImage: [function($event) {
      var $async$goto = 0, $async$completer = P.Completer_Completer$sync(), $async$returnValue, t1, t2, t3, files, reader, resultReceived;
      var $async$loadImage = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              B.changeScale(1);
              t1 = document;
              t1.querySelector("#convertedTextArea").textContent = "";
              J.setInnerHtml$1$x(t1.querySelector("#scaleArea"), "<div id='scaleUp'><i class='fas fa-plus-circle'></i></div><div id='scaleDown'><i class='fas fa-minus-circle'></i></div><div id='scaleReset'><i class='fas fa-redo-alt'></i></div>");
              t2 = t1.querySelector("#scaleDown");
              t3 = t2.style;
              t3.display = "inline";
              t2 = J.get$onClick$x(t2);
              W._EventStreamSubscription$(t2._html$_target, t2._eventType, B.scale__scaleDown$closure(), false, H.getTypeArgumentByIndex(t2, 0));
              t2 = t1.querySelector("#scaleUp");
              t3 = t2.style;
              t3.display = "inline";
              t2 = J.get$onClick$x(t2);
              W._EventStreamSubscription$(t2._html$_target, t2._eventType, B.scale__scaleUp$closure(), false, H.getTypeArgumentByIndex(t2, 0));
              t1 = t1.querySelector("#scaleReset");
              t2 = t1.style;
              t2.display = "inline";
              t1 = J.get$onClick$x(t1);
              W._EventStreamSubscription$(t1._html$_target, t1._eventType, B.scale__scaleReset$closure(), false, H.getTypeArgumentByIndex(t1, 0));
              files = H.interceptedTypeCast(J.get$target$x($event), "$isFileUploadInputElement").files;
              reader = new FileReader();
              t1 = new W._EventStream(reader, "load", false, [W.ProgressEvent]);
              resultReceived = t1.get$first(t1);
              if (0 >= files.length) {
                $async$returnValue = H.ioore(files, 0);
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              $async$goto = 3;
              return P._asyncAwait(resultReceived, $async$loadImage);
            case 3:
              // returning from await.
              U.imageProcessing(C.FileReader_methods.get$result(reader));
            case 1:
              // return
              return P._asyncReturn($async$returnValue, $async$completer);
          }
      });
      return P._asyncStart($async$loadImage, $async$completer);
    }, "call$1", "image__loadImage$closure", 2, 0, 20],
    imageProcessing: function(src) {
      var t1, canvas, context, e;
      t1 = document;
      ...
      if (src != null)
        e.src = src;
      W._EventStreamSubscription$(e, "load", new U.imageProcessing_closure(canvas, context, e), false, W.Event);
    },
    convertToEmoji: function(data, width) {
      var t1, threshold, emoji1, emoji2, convertedTextArea, t2, i, t3;
      t1 = document;
      threshold = H.Primitives_parseInt(J.get$value$x(t1.querySelector("#threshold")), null, null);
      emoji1 = J.get$value$x(t1.querySelector("#emoji1"));
      emoji2 = J.get$value$x(t1.querySelector("#emoji2"));
      convertedTextArea = t1.querySelector("#convertedTextArea");
      for (t1 = data.length, t2 = J.getInterceptor$x(convertedTextArea), i = 0; i < t1; i += 4) {
        t3 = i + 3;
        if (t3 >= t1)
          return H.ioore(data, t3);
        if (data[t3] === 0)
          t2.insertAdjacentHtml$2(convertedTextArea, "beforeend", emoji1);
        else {
          t3 = data[i];
          if (typeof threshold !== "number")
            return H.iae(threshold);
          if (t3 < threshold)
            t2.insertAdjacentHtml$2(convertedTextArea, "beforeend", emoji2);
          else
            t2.insertAdjacentHtml$2(convertedTextArea, "beforeend", emoji1);
        }
        if (typeof width !== "number")
          return H.iae(width);
        if (C.JSDouble_methods.$mod(i / 4 + 1, width) === 0 && i + 1 > width)
          t2.insertAdjacentHtml$2(convertedTextArea, "beforeend", "<br>");
      }
    },
    convertToColor: function(data, width) {
      var t1, convertedTextArea, downloadFileName, t2, t3, downloadText, i, t4, t5, t6, rgba, blob, downloadLink;
      t1 = document;
      convertedTextArea = t1.querySelector("#convertedTextArea");
      downloadFileName = H.stringReplaceAllUnchecked(H.stringReplaceAllUnchecked(J.toString$0$(J.get$value$x(t1.querySelector("#file"))), ".png", ""), "C:\\fakepath\\", "");
      for (t2 = data.length, t3 = J.getInterceptor$x(convertedTextArea), downloadText = "", i = 0; i < t2; i += 4) {
        t4 = "rgba(" + data[i] + ",";
        t5 = i + 1;
        if (t5 >= t2)
        ...
        rgba = t6 + data[t4] + ")";
        t3.insertAdjacentHtml$2(convertedTextArea, "beforeend", "<font id='" + i + "'>\u25a0</font>");
        t4 = t1.getElementById("" + i).style;
        t4.color = rgba;
        downloadText += "<font style='color:" + rgba + "'>\u25a0</font>";
        if (typeof width !== "number")
          return H.iae(width);
        if (C.JSDouble_methods.$mod(i / 4 + 1, width) === 0 && t5 > width) {
          t3.insertAdjacentHtml$2(convertedTextArea, "beforeend", "<br>");
          downloadText += "<br>";
        }
      }
      t2 = downloadFileName + ".html";
      blob = W.Blob_Blob([downloadText], null, null);
      if (J.$index$asx(J.$index$asx($.$get$context(), "navigator"), "msSaveBlob") != null)
        H.throwNoSuchMethod("", "msSaveBlob", [blob, "svg_contents.svg"], null);
      else {
        downloadLink = t1.querySelector("#download");
        t1 = J.getInterceptor$x(downloadLink);
        t1.set$href(downloadLink, (self.URL || self.webkitURL).createObjectURL(blob));
        downloadLink.textContent = "Download";
        t1.set$download(downloadLink, t2);
        t2 = downloadLink.style;
        t2.display = "";
      }
    },
    imageProcessing_closure: {
      "^": "Closure:0;canvas,context,img",
      call$1: function(e) {
        var t1, height, width, t2, t3, imageData, fontSize, data;
        t1 = this.img;
        height = t1.height;
        width = t1.width;
        ...
        t2 = height + width;
        if (t2 > 1400) {
          height = H.Primitives_parseInt(H.stringReplaceAllUnchecked(C.JSDouble_methods.toString$0(height / (t2 / 600)), P.RegExp_RegExp("\\.(.*)", true, false), ""), null, null);
          t2 = t1.width;
          t3 = t1.height;
          if (typeof t3 !== "number")
            return t3.$add();
          if (typeof t2 !== "number")
            return H.iae(t2);
          width = H.Primitives_parseInt(H.stringReplaceAllUnchecked(C.JSDouble_methods.toString$0(t2 / ((t3 + t2) / 600)), P.RegExp_RegExp("\\.(.*)", true, false), ""), null, null);
        }
        t2 = this.canvas;
        t3 = J.getInterceptor$x(t2);
        t3.set$height(t2, height);
        t3.set$width(t2, width);
        t2 = this.context;
        t3 = J.getInterceptor$x(t2);
        t3.drawImageScaled$5(t2, t1, 0, 0, width, height);
        imageData = t3.getImageData$4(t2, 0, 0, width, height);
        t2 = document;
        fontSize = J.get$value$x(t2.querySelector("#fontSize"));
        t3 = t2.querySelector("#convertedTextArea").style;
        t1 = H.S(fontSize) + "mm";
        t3.fontSize = t1;
        data = J.get$data$x(imageData);
        if (J.get$value$x(t2.querySelector("#convertType")) === "emoji")
          U.convertToEmoji(data, width);
        else
          U.convertToColor(data, width);
      }
    }
  }], ["", "../src/main.dart",, F, {
    "^": "",
    main: [function() {
      var t1, t2;
      t1 = document;
      t2 = J.get$onChange$x(t1.querySelector("#file"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, U.image__loadImage$closure(), false, H.getTypeArgumentByIndex(t2, 0));
      t1 = J.get$onChange$x(t1.querySelector("#convertType"));
      W._EventStreamSubscription$(t1._html$_target, t1._eventType, K.ui__showEmojSelect$closure(), false, H.getTypeArgumentByIndex(t1, 0));
    }, "call$0", "main__main$closure", 0, 0, 1]
  }, 1], ["", "../src/scale.dart",, B, {
    "^": "",
    scaleDown: [function($event) {
      var t1 = $.scale;
      if (t1 !== 0.20000000000000015) {
        t1 -= 0.1;
        $.scale = t1;
        B.changeScale(t1);
      }
    }, "call$1", "scale__scaleDown$closure", 2, 0, 0],
    ...
    }, "call$1", "scale__scaleUp$closure", 2, 0, 0],
    scaleReset: [function($event) {
      $.scale = 1;
      B.changeScale(1);
    }, "call$1", "scale__scaleReset$closure", 2, 0, 0],
    changeScale: function(scale) {
      var t1, t2;
      t1 = document.querySelector("#container").style;
      t2 = "scale(" + H.S(scale) + ")";
      C.CssStyleDeclaration_methods._setPropertyHelper$3(t1, (t1 && C.CssStyleDeclaration_methods)._browserPropertyName$1(t1, "-webkit-transform"), t2, null);
      t2 = "scale(" + H.S(scale) + ")";
      C.CssStyleDeclaration_methods._setPropertyHelper$3(t1, C.CssStyleDeclaration_methods._browserPropertyName$1(t1, "-moz-transform   "), t2, null);
      t2 = "scale(" + H.S(scale) + ")";
      C.CssStyleDeclaration_methods._setPropertyHelper$3(t1, C.CssStyleDeclaration_methods._browserPropertyName$1(t1, "-ms-transform    "), t2, null);
      t2 = "scale(" + H.S(scale) + ")";
      C.CssStyleDeclaration_methods._setPropertyHelper$3(t1, C.CssStyleDeclaration_methods._browserPropertyName$1(t1, "-o-transform     "), t2, null);
      t2 = "scale(" + H.S(scale) + ")";
      C.CssStyleDeclaration_methods._setPropertyHelper$3(t1, C.CssStyleDeclaration_methods._browserPropertyName$1(t1, "transform        "), t2, null);
    }
  }], ["", "../src/ui.dart",, K, {
    "^": "",
    showEmojSelect: [function($event) {
      var t1 = document;
      if (J.get$value$x(t1.querySelector("#convertType")) === "color") {
        t1 = t1.querySelector("#emojiSelect").style;
        t1.display = "none";
      } else {
        t1 = t1.querySelector("#emojiSelect").style;
        t1.display = "";
      }
    }, "call$1", "ui__showEmojSelect$closure", 2, 0, 0]
  }]];
  setupProgram(dart, 0);
  ...
  $ = new Isolate();
  init.metadata = ["value", null, "error", "stackTrace", "e", "_", "element", "invocation", "x", "result", "data", "attributeName", "context", "o", "object", "sender", "closure", "isolate", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "each", "errorCode", "arg", "attr", "callback", "captureThis", "self", "arguments"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, args: [W.Event]}];
